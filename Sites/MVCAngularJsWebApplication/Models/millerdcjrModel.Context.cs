...
namespace MVCAngularJsWebApplication.Models
{
    ...
    public partial class millerwebEntities : DbContext
    {
        ...
        public virtual int AddressCreate(string street, string street2, string city, Nullable<System.Guid> stateId, Nullable<System.Guid> countryId, string postalCode, string phoneNumber)
        {
            ...
            var stateIdParameter = stateId.HasValue ?
                ...
                new ObjectParameter("stateId", typeof(System.Guid));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("AddressCreate", streetParameter, street2Parameter, cityParameter, stateIdParameter, countryIdParameter, postalCodeParameter, phoneNumberParameter);
        }
    
        public virtual int AddressDelete(Nullable<System.Guid> addressId)
        {
            var addressIdParameter = addressId.HasValue ?
                new ObjectParameter("addressId", addressId) :
                new ObjectParameter("addressId", typeof(System.Guid));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("AddressDelete", addressIdParameter);
        }
    
        public virtual ObjectResult<AddressRead_Result> AddressRead(string street)
        {
            var streetParameter = street != null ?
                new ObjectParameter("street", street) :
                new ObjectParameter("street", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<AddressRead_Result>("AddressRead", streetParameter);
        }
    
        public virtual int AddressUpdate(Nullable<System.Guid> addressId, string street, string street2, string city, Nullable<System.Guid> stateId, Nullable<System.Guid> countryId, string postalCode, string phoneNumber)
        {
            var addressIdParameter = addressId.HasValue ?
                new ObjectParameter("addressId", addressId) :
                new ObjectParameter("addressId", typeof(System.Guid));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("AddressUpdate", addressIdParameter, streetParameter, street2Parameter, cityParameter, stateIdParameter, countryIdParameter, postalCodeParameter, phoneNumberParameter);
        }
        ...
        public virtual int ClientCreate(string name, Nullable<bool> enabled)
        {
            var nameParameter = name != null ?
                new ObjectParameter("name", name) :
                new ObjectParameter("name", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("ClientCreate", nameParameter, enabledParameter);
        }
    
        public virtual int ClientDisable(Nullable<System.Guid> clientID, Nullable<bool> enabled)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("ClientDisable", clientIDParameter, enabledParameter);
        }
    
        public virtual ObjectResult<ClientRead_Result> ClientRead(string name, Nullable<bool> enabled)
        {
            var nameParameter = name != null ?
                new ObjectParameter("name", name) :
                new ObjectParameter("name", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<ClientRead_Result>("ClientRead", nameParameter, enabledParameter);
        }
    
        public virtual int ClientUpdate(Nullable<System.Guid> clientID, string name, Nullable<bool> enabled)
        {
            var clientIDParameter = clientID.HasValue ?
                new ObjectParameter("clientID", clientID) :
                new ObjectParameter("clientID", typeof(System.Guid));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("ClientUpdate", clientIDParameter, nameParameter, enabledParameter);
        }
    
        public virtual int CountryCreate(ObjectParameter name, ObjectParameter isoCode2, ObjectParameter isoCode3, ObjectParameter countryID)
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("CountryCreate", name, isoCode2, isoCode3, countryID);
        }
    
        public virtual int CountryDelete(ObjectParameter name, ObjectParameter isoCode2, ObjectParameter isoCode3, ObjectParameter countryID)
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("CountryDelete", name, isoCode2, isoCode3, countryID);
        }
    
        public virtual ObjectResult<CountryRead_Result> CountryRead(string name, string isoCode2, string isoCode3)
        {
            var nameParameter = name != null ?
                new ObjectParameter("name", name) :
                new ObjectParameter("name", typeof(string));
    
            var isoCode2Parameter = isoCode2 != null ?
                new ObjectParameter("isoCode2", isoCode2) :
                new ObjectParameter("isoCode2", typeof(string));
    
            var isoCode3Parameter = isoCode3 != null ?
                new ObjectParameter("isoCode3", isoCode3) :
                new ObjectParameter("isoCode3", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<CountryRead_Result>("CountryRead", nameParameter, isoCode2Parameter, isoCode3Parameter);
        }
    
        public virtual int CountryUpdate(ObjectParameter name, ObjectParameter isoCode2, ObjectParameter isoCode3, ObjectParameter countryID)
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("CountryUpdate", name, isoCode2, isoCode3, countryID);
        }
    
        public virtual int CountryZonesCreate(ObjectParameter stateId, ObjectParameter name, ObjectParameter code, ObjectParameter countryID)
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("CountryZonesCreate", stateId, name, code, countryID);
        }
    
        public virtual int CountryZonesDelete(ObjectParameter countryID, ObjectParameter stateID, ObjectParameter name, ObjectParameter code)
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("CountryZonesDelete", countryID, stateID, name, code);
        }
    
        public virtual ObjectResult<CountryZonesRead_Result> CountryZonesRead(ObjectParameter stateID, ObjectParameter name, ObjectParameter code, ObjectParameter countryID)
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<CountryZonesRead_Result>("CountryZonesRead", stateID, name, code, countryID);
        }
    
        public virtual int CountryZonesUpdate(Nullable<System.Guid> countryZoneID, string name, string code, Nullable<System.Guid> countryID)
        {
            var countryZoneIDParameter = countryZoneID.HasValue ?
                new ObjectParameter("countryZoneID", countryZoneID) :
                new ObjectParameter("countryZoneID", typeof(System.Guid));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("CountryZonesUpdate", countryZoneIDParameter, nameParameter, codeParameter, countryIDParameter);
        }
    
        public virtual int insertLink(string linkName, string linkURL, Nullable<bool> isActive)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("insertLink", linkNameParameter, linkURLParameter, isActiveParameter);
        }
    
        public virtual int LogsCreate(string applicationName, string type, string description, Nullable<System.DateTime> timeStamp, string source, string message, string stackTrace)
        {
            var applicationNameParameter = applicationName != null ?
                new ObjectParameter("ApplicationName", applicationName) :
                new ObjectParameter("ApplicationName", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("LogsCreate", applicationNameParameter, typeParameter, descriptionParameter, timeStampParameter, sourceParameter, messageParameter, stackTraceParameter);
        }
    
        public virtual int selectLinks()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("selectLinks");
        }
    }
}
